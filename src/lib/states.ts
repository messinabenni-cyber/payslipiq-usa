...
export const STATES: StateData[] = [
  ...
  { slug: 'maine', name: 'Maine', abbr: 'ME', category: 'progressive', hasLocalTax: false, hasSDI: false, hasPFL: true, dailyOvertime: false, taxAuthority: 'Maine Revenue Services', taxAuthorityUrl: 'https://www.maine.gov/revenue/' },
  { slug: 'maryland', name: 'Maryland', abbr: 'MD', category: 'progressive', hasLocalTax: true, hasSDI: false, hasPFL: false, dailyOvertime: false, taxAuthority: 'Comptroller of Maryland', taxAuthorityUrl: 'https://www.marylandtaxes.gov/' },
  ...
  { slug: 'minnesota', name: 'Minnesota', abbr: 'MN', category: 'progressive', hasLocalTax: false, hasSDI: false, hasPFL: true, dailyOvertime: false, taxAuthority: 'Minnesota Department of Revenue', taxAuthorityUrl: 'https://www.revenue.state.mn.us/' },
