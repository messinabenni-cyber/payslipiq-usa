...
<tr><td>Authentication</td><td>No live premium login today. If paid saved reports open, the plan is OAuth or email magic-link. No plaintext passwords stored.</td></tr>
<tr><td>Secrets</td><td>Environment-scoped secret managers. Rotated on a published schedule.</td></tr>
</tbody>
</table>
<h2>Data minimization</h2>
<p>The pay stub explainer does not require an account. Saved paid reports are not a live product today. We collect only what is needed for the feature you are using.</p>
...
<ul>
<li>Store credit card data on our servers. If paid products go live, billing would use a PCI-compliant processor. Checkout is not live.</li>
...
<tr><td>Email provider</td><td>Transactional email (waitlist and contact)</td><td>US</td></tr>
<tr><td>Payment processor</td><td>Not in use. Checkout is not live. Would be named here if billing starts.</td><td>—</td></tr>
