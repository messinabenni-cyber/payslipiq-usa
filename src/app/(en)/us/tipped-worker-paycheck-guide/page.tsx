...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://payslipiq.com/us/tipped-worker-paycheck-guide', languages: { 'en-US': 'https://payslipiq.com/us/tipped-worker-paycheck-guide', 'en-GB': 'https://payslipiq.co.uk', 'en-IE': 'https://payslipiq.co.uk/ie', 'x-default': 'https://payslipiq.com/us/tipped-worker-paycheck-guide' } },
};
