      ...
      <main id="main" className="mx-auto max-w-3xl px-4 py-10">
        ...
        <section className="mt-12">
          ...
          <ol className="list-decimal pl-6 space-y-3 text-slate-700">
            ...
            <li><strong>State worker contributions.</strong> CA SDI 1.3%; NY SDI ($31.20/yr cap) + NY PFL 0.432%; NJ SDI 0.19% + FLI 0.23%; MA PFML 0.46%; OR Paid Leave 0.6%; WA PFML 0.807% + WA Cares 0.58%; RI TDI 1.1%; CO FAMLI 0.44%; HI TDI 0.5%. Should appear as separate lines on your stub if applicable.</li>
