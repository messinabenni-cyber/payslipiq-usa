...
const CITIES = [
  ...
  { city: 'Louisville Metro (KY)', rate: '2.2% resident / 1.45% nonresident', who: 'Wages for work in Louisville Metro', source: 'https://louisvilleky.gov/revenue-commission/forms/form-ol-3-occupational-license-return' },
