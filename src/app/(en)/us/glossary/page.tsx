...
const TERMS: Term[] = [
  { term: '401(k)', body: 'Employer-sponsored retirement plan with pre-tax (traditional) and post-tax (Roth) options. Pre-tax 401(k) reduces your federal taxable wages. Annual limit $24,500 in 2026, $32,500 if age 50+.' },
  ...
  { term: 'CA SDI', body: 'California State Disability Insurance. Mandatory employee contribution, 1.3% of all wages with no wage cap (as of 2026). Funds short-term disability and PFL.' },
  ...
  { term: 'FICA', body: 'Federal Insurance Contributions Act. Combined 7.65%: 6.2% Social Security up to wage base ($184,500 in 2026), 1.45% Medicare on every dollar.' },
  ...
  { term: 'FSA (Flexible Spending Account)', body: 'Pre-tax account for health or dependent-care expenses. Use-it-or-lose-it. 2026 limits: $3,400 health FSA, $5,000 dependent-care FSA.' },
  ...
  { term: 'HSA (Health Savings Account)', body: 'Pre-tax savings paired with a high-deductible health plan. 2026 limits: $4,400 self, $8,750 family, +$1,000 catch-up if 55+.' },
  ...
  { term: 'Social Security', body: 'Federal retirement program. Employee FICA contribution: 6.2% up to the annual wage base ($184,500 in 2026, indexed).' },
  ...
  { term: 'Wage base (Social Security)', body: 'The annual cap on Social Security taxable wages. $184,500 for 2026. Above this, no more Social Security tax (Medicare continues).' },
