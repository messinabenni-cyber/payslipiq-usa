          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border border-slate-200 text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                ...
                <tr><td className="px-3 py-2">State worker contributions (SDI/PFL/PFML/TDI/FAMLI)</td><td className="px-3 py-2">14 jurisdictions explicit</td><td className="px-3 py-2">Partial</td></tr>
