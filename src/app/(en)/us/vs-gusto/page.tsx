...
const FAQS = [
  ...
  { q: 'Does PayslipIQ cover all 50 states like Gusto?', a: 'Yes. PayslipIQ covers all 50 states plus DC, plus 14 jurisdictions with explicit employee worker contributions and dedicated pages for major metros.' },
];
