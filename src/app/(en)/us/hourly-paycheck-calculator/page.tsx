...
export default function Page() {
  return (
    ...
    <RichArticle
      ...
      description="Hourly paycheck calculator for US workers. Hours times rate, overtime, federal, FICA, state. Educational only."
      intro={<>Hourly paycheck math: regular hours times rate, plus overtime hours times 1.5x rate, minus federal income tax, FICA, and state tax. Local tax is optional on the paycheck calculator (default none). Pre-tax 401(k) and similar deductions only if you enter them. PayslipIQ estimates those lines; it does not run your actual payroll.</>}
...
<p>Use the <a href="/us/paycheck-calculator">paycheck calculator</a>, set frequency to Weekly or Bi-weekly, and enter (hours × rate) as your gross. Pick a locality if you have city or county tax (default is none). Enter pre-tax amounts if you have them.</p>
