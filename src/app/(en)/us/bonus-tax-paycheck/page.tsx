...
<p>Bonuses are subject to Social Security (6.2 percent up to the wage base) and Medicare (1.45 percent on every dollar). Plus the 0.9 percent Additional Medicare on wages above $200,000. Employee-paid state programs such as California SDI, New York PFL, New Jersey SDI/FLI, and Maine PFML also typically apply to the bonus. The calculator includes those 2026 rates for the selected state. Local city or county tax is included when you pick a locality.</p>
<h2>Do the 2025 "no tax" deductions cover bonuses?</h2>
<p>No. The One Big Beautiful Bill created federal income-tax deductions for qualified <a href="/us/overtime-paycheck">overtime</a> and <a href="/us/tipped-worker-paycheck-guide">tips</a> for tax years 2025 through 2028, but a bonus is neither. A bonus is supplemental wages, fully subject to federal income tax and FICA. If one paycheck includes both a bonus and qualifying overtime, only the overtime premium may count toward the overtime deduction. The bonus itself does not. Verify any deduction with the IRS or a qualified tax professional.</p>
