...
const FAQS = [
  ...
  { q: 'What lines should I expect on a Minneapolis paycheck?', a: 'Minneapolis has no city income tax, so beyond the federal lines (federal income tax, Social Security 6.2% to $184,500, Medicare 1.45%) the only state line is Minnesota income tax, charged on progressive brackets from 5.35% up to 9.85%. As Minnesota PFML phases in for 2026, a small employee-share paid-leave premium also appears. Pre-tax 401(k), HSA, FSA or Section 125 health show up only when elected.' },
