...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Upload a ${s.name} pay stub. PayslipIQ explains every line in plain English. Educational only.`,
...
export default function Page({ params }: PageProps) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p className="mt-3 text-lg text-slate-700">Upload a {s.name} pay stub. PayslipIQ explains every line in plain English.</p>
