...
const FAQS = [
  ...
  { q: 'Why is NYC so much higher than Yonkers?', a: 'NYC has its own progressive income tax with a top resident rate around 3.876%. Yonkers does not have its own income tax in the same form, it instead applies a 1.96% surcharge to your New York State personal income tax (so your effective additional rate is much lower than NYC). Both apply only to residents, not to commuters who work in those cities but live elsewhere.' },
...
const CITIES = [
  ...
  { city: 'Yonkers (NY)', rate: '~1.96% surcharge of NYS tax', who: 'Residents', source: 'https://www.tax.ny.gov/' },
