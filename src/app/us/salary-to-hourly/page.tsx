...
const FAQS = [
  ...
  { q: 'Are FLSA-exempt salaried roles paid for overtime?', a: 'Usually no. FLSA-exempt roles (executive, administrative, professional, computer, outside sales, certain commission roles) do not have to be paid overtime regardless of hours worked. The Department of Labor sets a minimum salary threshold for exemption (around $58,656 annual as of 2024 thresholds, currently subject to legal challenge). Below the threshold, you are non-exempt and must be paid 1.5x for hours over 40.' },
