...
export const metadata: Metadata = {
  ...
  description: "Upload a US pay stub or paste paycheck numbers. PayslipIQ explains every line — gross pay, federal withholding, FICA, state tax, deductions, net pay — in plain English. Educational only.",
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      <p className="mt-3 text-lg text-slate-700">
        Upload your pay stub or paste the numbers. We&apos;ll walk you through every line in plain English.
      </p>
      <div className="mt-4">
