...
const FAQS = [
  ...
  { q: 'What lines should I expect on a Charlotte paycheck?', a: 'Federal income tax. Social Security (6.2% to $184,500). Medicare (1.45%). North Carolina flat 3.99%. Pre-tax 401(k), HSA, FSA, Section 125 health if elected. No city or county tax line.' },
