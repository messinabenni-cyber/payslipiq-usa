...
const FAQS = [
  ...
  { q: 'What lines should I expect on a San Diego paycheck?', a: 'Federal income tax. Social Security (6.2% to $184,500). Medicare (1.45%). Additional Medicare (0.9%) above $200,000 YTD. California state income tax (progressive bracket). CA SDI 1.3%. Pre-tax 401(k), HSA, FSA, Section 125 health if elected.' },
];
