...
export const metadata: Metadata = {
  title: 'Newark NJ Paycheck Calculator (2026) — NJ + No Employee Newark Payroll Tax',
  description:
    'Newark NJ paycheck calculator. Federal, FICA, NJ progressive + NJ SDI 0.23% + NJ FLI 0.19%. Newark Payroll Tax is employer-paid only — no employee withholding line. 2026 rates.',
...
const FAQS = [
  ...
  { q: 'What lines should I expect on a Newark paycheck?', a: 'Federal income tax. Social Security (6.2% to SSA wage base $184,500). Medicare (1.45%). NJ state income tax (progressive brackets, top 10.75%). NJ SDI 0.23% (capped at $393.53/yr). NJ FLI 0.19% (capped at $325.09/yr). Standard pre-tax deductions if elected (401k, HSA, FSA, Section 125 health).' },
