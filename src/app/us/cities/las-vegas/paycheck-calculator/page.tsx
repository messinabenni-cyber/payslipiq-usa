...
const FAQS = [
  ...
  { q: 'What lines should I expect on a Las Vegas paycheck?', a: 'Federal income tax. Social Security (6.2% to $184,500). Medicare (1.45%). Optional pre-tax 401(k), HSA, FSA, Section 125 health. Optional post-tax Roth 401(k). No state or local tax lines.' },
